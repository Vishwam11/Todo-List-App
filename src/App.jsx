...
import { FaEdit } from "react-icons/fa";                          //react edit icon
import { AiFillDelete } from "react-icons/ai";                    //react delete icon 
import { v4 as uuidv4 } from 'uuid';                              //unique id for tasks 

function App() { 

  const [todo, setTodo] = useState("")
  const [todos, setTodos] = useState([])
  const [showFinished, setshowFinished] = useState(true)          //initial state is true
